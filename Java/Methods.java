/*****************************************************************************************
 * ---------------------- GUESS NUMBER ------------------------
 * THIS METHOD WILL GUESS THE USER NUMBER
 ****************************************************************************************/

package o1_fundamentals;

import java.util.Scanner; // Scanner is a class that contains a bunch of methods

public class O10_Methods {

	// This is a class variable that is available to every method
	// If you declare a variable in a method it is only accessible
	// in that method (local variable)
	static double myPI = 3.14159265;

	// Any changes made to randomNumber in any functions
	// will effect its global value
	...
	// When we define an attribute / parameter we must define its type
	...
	public static int getRandomNum() {
		...
		// or define its type. Since randomNumber is a class variable
		// we don't have to declare, If int randomNumber was declared
		// in this method it wouldn't effect the global variable named randomNumber
